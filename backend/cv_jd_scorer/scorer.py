...
from cv_jd_scorer import heuristics
from cv_jd_scorer import jd_fit as jd_fit_scorer
from cv_jd_scorer import overview as overview_module
from cv_jd_scorer import skill_gap as skill_gap_scorer
...
def compute(parsed_cv: dict, jd_text: str) -> ScoreResult:
    ...
    overview_result = overview_module.compute(
        ...
        peer_percentile=peer_bucket_idx * 7,  # bucket index → rough percentile
        comp_you=comp_you,
        comp_p50=comp_p50,
        align_avg=align_avg,
