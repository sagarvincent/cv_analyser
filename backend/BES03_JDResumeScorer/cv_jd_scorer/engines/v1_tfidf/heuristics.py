...
from cv_jd_scorer.engines.v1_tfidf.data.role_profiles import ROLES
from cv_jd_scorer.engines.v1_tfidf.data.salary_bands import BANDS, MARKET_WEIGHTS
...
# -- Calls : clamp_unit, detect_seniority, _extract_center_role
# -- Called by: scorer.compute
