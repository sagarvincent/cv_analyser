from cv_jd_scorer.common.cv_features import calc_exp_years, detect_seniority
from cv_jd_scorer.engines.v1_tfidf import ats as ats_scorer
from cv_jd_scorer.engines.v1_tfidf import heuristics
from cv_jd_scorer.engines.v1_tfidf import jd_fit as jd_fit_scorer
...
from cv_jd_scorer.engines.v1_tfidf.leaves.score_leaves import clamp_unit
...
# -------------------- compute ----------- START ----------
# -- Calls : jd_fit_scorer.score, ats_scorer.score, skill_gap_scorer.score,
#            heuristics.compute_peer, heuristics.compute_comp,
#            heuristics.compute_alt_paths, heuristics.compute_alignment,
#            overview_module.compute, detect_seniority, calc_exp_years, _build_trace
# -- Called by: V1TfidfEngine.compute
