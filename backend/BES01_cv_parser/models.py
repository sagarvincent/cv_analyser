...
class AtsRedFlags(BaseModel):
    ...
    # sections found only by the fuzzy alias pass (strict pass missed them)
    sections_recovered_by_fuzzy_only: int = 0
    # experience entries containing 2+ date ranges = job-boundary failure
    experience_boundary_failures: int = 0
